...
import { Scale, MessageCircle, Settings, LogOut, Zap, ChevronDown, User as UserIcon, Clock, TrendingUp, Activity, BarChart3, FileText } from 'lucide-react'
...
interface UserProfile {
  ...
  // Removed: free_starter_claimed - not needed with automatic provisioning
...
export default function DashboardPage() {
  ...
  // Removed: Free token claiming functionality
  ...
  // Removed: Free token claiming is automatic on signup
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
          ...
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative" ref={userMenuRef}>
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-50 border border-gray-200 dark:border-gray-600">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-700 p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">{t('dashboard.tokenBalance')}</h2>
            ...
            <div className="flex space-x-8">
              <div>
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-gray-600 dark:text-gray-300">{t('dashboard.availableTokens')}</span>
                </div>
              ...
              <div>
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-gray-600 dark:text-gray-300">{t('dashboard.totalPurchased')}</span>
                </div>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-700 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">{t('dashboard.totalConversations')}</p>
...
{t('dashboard.viewAllConversations')}
        ...
        {/* Removed: Free token claiming - tokens are provisioned automatically on signup */}
